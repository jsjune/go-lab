...
const file_item_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"item.proto\x12\x04item\"\x12\n" +
	"\x10ListItemsRequest\"=\n" +
	"\x11ListItemsResponse\x12(\n" +
	"\x05items\x18\x01 \x03(\v2\x12.item.ItemResponseR\x05items\" \n" +
	...
	"\n" +
	"created_at\x18\x04 \x01(\tR\tcreatedAt2\xb7\x02\n" +
	"\vItemService\x12<\n" +
	"\tListItems\x12\x16.item.ListItemsRequest\x1a\x17.item.ListItemsResponse\x123\n" +
	"\aGetItem\x12\x14.item.GetItemRequest\x1a\x12.item.ItemResponse\x129\n" +
	"\n" +
	...
	"\n" +
	"DeleteItem\x12\x17.item.DeleteItemRequest\x1a\x18.item.DeleteItemResponseB\x19Z\x17go-sample-http/gen/itemb\x06proto3"
...
var file_item_proto_goTypes = []any{
	(*ListItemsRequest)(nil),   // 0: item.ListItemsRequest
	(*ListItemsResponse)(nil),  // 1: item.ListItemsResponse
...
var file_item_proto_depIdxs = []int32{
	...
	0, // 1: item.ItemService.ListItems:input_type -> item.ListItemsRequest
	2, // 2: item.ItemService.GetItem:input_type -> item.GetItemRequest
	...
	1, // 6: item.ItemService.ListItems:output_type -> item.ListItemsResponse
	7, // 7: item.ItemService.GetItem:output_type -> item.ItemResponse
